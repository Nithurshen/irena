...
void print_usage() {
    std::printf(
        "irena - OpenCL path tracer with Vulkan interop\n"
        "\n"
        "  irena <file>              render one scene next to the input as <name>_output.png\n"
        "  irena <directory>         render every scene into <directory>/output/<name>.png\n"
        "\n"
